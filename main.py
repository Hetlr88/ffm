...
AppId=os.environ.get("API_ID",29452145)  #Replace With Your Own
AppHash=os.environ.get("API_HASH","5a2784e571fe5043852d32396a34a13b") #Replace With Your Own
BotToken=os.environ.get("BOT_TOKEN","7445547849:AAHfX4_8TQ57cg71Q_l9ABoa6RfgfPWHgsE")  #Replace With Your Own
